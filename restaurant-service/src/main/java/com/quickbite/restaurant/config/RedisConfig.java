...
public class RedisConfig implements CachingConfigurer {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put("restaurantById", defaultConfig.entryTtl(Duration.ofMinutes(5)));
        cacheConfigurations.put("restaurantsByOwner", defaultConfig.entryTtl(Duration.ofMinutes(5)));
        cacheConfigurations.put("restaurantsByCuisine", defaultConfig.entryTtl(Duration.ofMinutes(5)));
        cacheConfigurations.put("restaurantsByCity", defaultConfig.entryTtl(Duration.ofMinutes(5)));
